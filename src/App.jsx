    ...
    <main ref={mainRef} className="overflow-x-hidden">
      ...
      >
        <section className="relative grid place-items-center h-[100vh]">
          ...
          <p className="text-white text-center absolute bottom-[5%] mx-4 w-fit text-lg font-bold">
            Самые продаваемые в мире часы стали ещё тоньше и получили самый
            большой и продвинутый дисплей, уведомления о апноэ во сне, более
            быструю зарядку, а также функцию определения глубины и температуры
            воды
          </p>
